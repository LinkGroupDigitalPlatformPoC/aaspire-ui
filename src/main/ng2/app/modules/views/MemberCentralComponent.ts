...
export class MemberCentralComponent {
    ...
    private consumeAddEngagementResult(result: any) {
        ...
        call.callId = resultObj._id; // @ICtodo: get next available call identifier from add engagement API
        ...
        this.router.navigateByUrl('/call/' + resultObj._id); // waiting for API team to return a call number
    }
